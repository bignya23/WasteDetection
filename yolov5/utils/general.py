...
def check_file(file, suffix=""):
    ...
    if os.path.isfile(file) or not file:  # exists
        ...
        ), "ClearML is not installed, so cannot use ClearML images. Try running 'pip install clearml'."
        return file
    else:  # search
        files = []
...
def check_dataset(data, autodownload=True):
    """Validates and/or auto-downloads a images, returning its configuration as a dictionary."""
    # Download (optional)
    extract_dir = ""
