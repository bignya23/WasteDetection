...
class CometLogger:
    ...
    def check_dataset(self, data_file):
        """Validates the images configuration by loading the YAML file specified in `data_file`."""
    ...
    def preprocess_prediction(self, image, labels, shape, pred):
        """Processes prediction data, resizing labels and adding images metadata."""
    ...
    def add_assets_to_artifact(self, artifact, path, asset_path, split):
        """Adds image and label assets to a wandb artifact given images split and paths."""
    ...
    def upload_dataset_artifact(self):
        """Uploads a YOLOv5 images as an artifact to the Comet.ml platform."""
        dataset_name = self.data_dict.get("dataset_name", "yolov5-images")
        ...
        artifact = comet_ml.Artifact(name=dataset_name, artifact_type="images", metadata=metadata)
    ...
    def download_dataset_artifact(self, artifact_path):
        """Downloads a images artifact to a specified directory using the experiment's logged artifact."""
        ...
        if isinstance(metadata_names, dict):
            ...
            raise "Invalid 'names' field in images yaml file. Please use a list or dictionary"

        return self.update_data_paths(data_dict)

    def update_data_paths(self, data_dict):
        """Updates data paths in the images dictionary, defaulting 'path' to an empty string if not present."""
