...
def run(
    ...
    Args:
        ...
        data (Path | str): Path to the images.yaml file (default: ROOT / "data/coco128.yaml").
...
def test(
    ...
    Args:
        ...
        data (Path | str): Path to the images configuration file (.yaml format). Default is 'ROOT / "data/coco128.yaml"'.
...
def parse_opt():
    ...
    Args:
        ...
        data (str): Path to the images YAML file. Defaults to 'ROOT / "data/coco128.yaml"'.
