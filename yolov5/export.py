...
def export_openvino(file, metadata, half, int8, data, prefix=colorstr("OpenVINO:")):
    ...
    Args:
        ...
        data (str): Path to the images YAML file required for INT8 quantization.
    ...
    if int8:
        ...
        def gen_dataloader(yaml_path, task="train", imgsz=640, workers=4):
            """Generates a DataLoader for model training or validation based on the given YAML images configuration."""
...
def export_tflite(
    ...
    Args:
        ...
        data (str): Path to the images for representative images generation in INT8 quantization.
    ...
    Notes:
        ...
        - INT8 quantization requires a representative images to achieve optimal accuracy.
...
def run(
    data=ROOT / "data/coco128.yaml",  # 'images.yaml path'
    ...
    Args:
        data (str | Path): Path to the images YAML configuration file. Default is 'data/coco128.yaml'.
